const mercadopago = new MercadoPago("TEST-01602238-1d40-41fa-a040-a66b69dfc930");
  ...
  const cardForm = mercadopago.cardForm({
    ...
    callbacks: {
      ...
      onSubmit: (event) => {
        ...
        console.log(paymentMethodId, issuerId, amount, email, token)

        fetch('https://localhost:44392/api/MercadoPago/pay', {
          method: 'POST',
          headers: {
